...
class Settings(BaseSettings):
    ...
    max_ocr_length: int = 500000  # Fixed max characters to store per document (not user-configurable)
    ...
    fuzzy_match_sample_size: int = 5000  # Characters to sample for fuzzy matching (increased for better accuracy)
