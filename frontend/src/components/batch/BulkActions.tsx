    ...
    switch (currentAction) {
      case 'delete':
        return itemType === 'documents'
          ? {
              ...
              description: `This will permanently delete ${count} document${
                count > 1 ? 's' : ''
              } from Paperless-NGX.`,
              details: [
          ...
          : {
              title: `Delete Duplicates in ${count} Group${
                count > 1 ? 's' : ''
              }`,
              description: `This will resolve ${count} duplicate group${
                count > 1 ? 's' : ''
              } by keeping the primary document and deleting the rest.`,
              details: [
      ...
      case 'mark-reviewed':
        return {
          ...
          description: `This will mark ${count} duplicate group${
            count > 1 ? 's' : ''
          } as reviewed.`,
          details: [
      ...
      case 'resolve':
        return {
          ...
          description: `This will resolve ${count} duplicate group${
            count > 1 ? 's' : ''
          } by keeping the primary document and removing the duplicates.`,
          details: [
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1 text-blue-800">
                  <p>
                    <strong>Mark Reviewed:</strong> Track examined groups
                    without changes
                  </p>
                  <p>
                    <strong>Mark Unreviewed:</strong> Remove reviewed status for
                    re-examination
                  </p>
                  <p>
                    <strong>Resolve Groups:</strong> Keep primary documents,
                    remove duplicates
                  </p>
                  <p>
                    <strong>Delete Duplicates:</strong> Permanently delete
                    duplicate documents
                  </p>
                </div>
                <p className="text-xs text-blue-700 mt-2">
                  💡 Tip: Use "Mark Reviewed" first to track your progress, then
                  "Resolve Groups" or "Delete Duplicates" to clean up.
                </p>
              </div>
            </div>
          </div>
              ...
              {(currentAction === 'delete' || currentAction === 'resolve') && (
                <div className="p-3 bg-red-50 border border-red-200 rounded-md">
                  ...
                  <p className="text-red-700 text-xs mt-1">
                    Documents will be permanently removed from Paperless-NGX.
