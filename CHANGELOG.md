...
## [0.18.2](https://github.com/rknightion/paperless-ngx-dedupe/compare/v0.18.1...v0.18.2) (2026-09-26)
...
* **ci:** exclude the generated design package and fix .coderabbit.yaml formatting ([#582](https://github.com/rknightion/paperless-ngx-dedupe/issues/582)) ([fa607c6](https://github.com/rknightion/paperless-ngx-dedupe/commit/fa607c64ae5e51ab74b4228c32e0650075dccf3c))
* **deps:** update opentelemetry-js monorepo ([#579](https://github.com/rknightion/paperless-ngx-dedupe/issues/579)) ([471e7e4](https://github.com/rknightion/paperless-ngx-dedupe/commit/471e7e404f5d2553cecc6e6a4af301765488f7c0))
* **deps:** update opentelemetry-js-contrib monorepo ([#581](https://github.com/rknightion/paperless-ngx-dedupe/issues/581)) ([36a11b9](https://github.com/rknightion/paperless-ngx-dedupe/commit/36a11b978cc258148c1c106b0bec29ec4db33d52))
...
* **ci:** bump ghcr-cleanup reusable to v1.22.0 ([475b1c0](https://github.com/rknightion/paperless-ngx-dedupe/commit/475b1c0daa8d399c6cb0fd8b17141853622caa78))
...
* **deps:** update davelosert/vitest-coverage-report-action action to v2.13.0 ([#578](https://github.com/rknightion/paperless-ngx-dedupe/issues/578)) ([5979324](https://github.com/rknightion/paperless-ngx-dedupe/commit/597932429dcc1dab504ec0d7a91458c6a17469bc))
...
* **deps:** update dependency @pyroscope/nodejs to v0.6.4 ([#583](https://github.com/rknightion/paperless-ngx-dedupe/issues/583)) ([91c08b1](https://github.com/rknightion/paperless-ngx-dedupe/commit/91c08b1bf30788b47704d0410a2b83d90360bb28))
...
* **deps:** update dependency @sveltejs/vite-plugin-svelte to v7.3.1 ([#584](https://github.com/rknightion/paperless-ngx-dedupe/issues/584)) ([061c433](https://github.com/rknightion/paperless-ngx-dedupe/commit/061c4330341c2777d9d432e9939f8a48875e988e))
* **deps:** update dependency drizzle-kit to v0.31.11 ([#586](https://github.com/rknightion/paperless-ngx-dedupe/issues/586)) ([82504fe](https://github.com/rknightion/paperless-ngx-dedupe/commit/82504fea3f7bb819059a6709fd5903275e161b7a))
...
* **deps:** update linters & formatters to v8.69.0 ([#580](https://github.com/rknightion/paperless-ngx-dedupe/issues/580)) ([8fec552](https://github.com/rknightion/paperless-ngx-dedupe/commit/8fec552934742e8bd1fa8fbc3963326d4d9eb61a))
...
* **deps:** update pnpm to v11.25.0 ([#577](https://github.com/rknightion/paperless-ngx-dedupe/issues/577)) ([88ff550](https://github.com/rknightion/paperless-ngx-dedupe/commit/88ff550a22e7a0f1c21b0098f95066a3399cb52c))
...
* **docs:** drop the dead [backlog] table from docs.toml ([b317bc8](https://github.com/rknightion/paperless-ngx-dedupe/commit/b317bc868d76b64770fd141420c2cd0a9fcbcf48))
...
* ignore machine-local codex/ ([77c1a4e](https://github.com/rknightion/paperless-ngx-dedupe/commit/77c1a4ed8d8b0b6adc68cefa10fc36c1cfaa659e))
...
* **pnpm:** lower the release-age floor to 6h to match the fleet cooldown ([709c89a](https://github.com/rknightion/paperless-ngx-dedupe/commit/709c89a37dae27786d651856d5b92bad6d366a8c))
* remove graft code graph wiring ([81cbdc8](https://github.com/rknightion/paperless-ngx-dedupe/commit/81cbdc88617a6b8200cdc452fe5ef557fd6c7e12))
* **reviews:** declare linked repositories for cross-repo review context ([c3b4536](https://github.com/rknightion/paperless-ngx-dedupe/commit/c3b4536c62bf279056c6e75547e10b5cea061401))
* **reviews:** mute biome here instead of org-wide ([22794f3](https://github.com/rknightion/paperless-ngx-dedupe/commit/22794f3de05c131b1b06c3b906e48f6d0e648dd5))
* **reviews:** mute oxc here instead of org-wide ([0640143](https://github.com/rknightion/paperless-ngx-dedupe/commit/06401436d1501ddca43819f693f4ccf7e2a9fa10))
* wire graft code graph via MCP ([a39062d](https://github.com/rknightion/paperless-ngx-dedupe/commit/a39062d1b8cd61c3c51baed3b742f5411341d4c8))


### Documentation

* adopt canonical routing and bounded root rescue ([4901fb8](https://github.com/rknightion/paperless-ngx-dedupe/commit/4901fb8c1272621347fbf375f72e24f83b39e8b7))
* **agents:** packages/core to AGENTS.md standard ([7ae0410](https://github.com/rknightion/paperless-ngx-dedupe/commit/7ae04106a9a891512d8c5172cb900991983fcb21))
* **agents:** packages/web to AGENTS.md standard ([2bc546b](https://github.com/rknightion/paperless-ngx-dedupe/commit/2bc546be6aa09a78c23a69eb8366825d2500a41d))
* **agents:** repo root to AGENTS.md standard ([ad583fc](https://github.com/rknightion/paperless-ngx-dedupe/commit/ad583fccb59474c0a9c4949aa47fbbbfe1767fc7))
* **agents:** review fix - packages/web ([d1b6c48](https://github.com/rknightion/paperless-ngx-dedupe/commit/d1b6c483eb9ba885c112b38449ee929e803207db))
* **agents:** review fix - repo root ([4ffa54e](https://github.com/rknightion/paperless-ngx-dedupe/commit/4ffa54e5529725445f844e7f2775ab661cc3948f))
* align recovery contracts and compaction evidence ([c0b1e0d](https://github.com/rknightion/paperless-ngx-dedupe/commit/c0b1e0db6f97c066357b41f323c74e2008b45976))
...
* publish canonical agent documents ([3e697bf](https://github.com/rknightion/paperless-ngx-dedupe/commit/3e697bfe45a18c7f92c6db0018e952efe5920762))
* publish canonical agent documents ([9ed9738](https://github.com/rknightion/paperless-ngx-dedupe/commit/9ed97385e18877d1c24eac7e62744ce53941f808))
* publish canonical agent documents ([9d6e28b](https://github.com/rknightion/paperless-ngx-dedupe/commit/9d6e28bcfc8f2bb105001150e2f19e277336972b))
* publish canonical agent documents ([3672032](https://github.com/rknightion/paperless-ngx-dedupe/commit/367203288cc632ed04822f1cc89a60a33fc05d98))
* publish canonical agent documents ([7920344](https://github.com/rknightion/paperless-ngx-dedupe/commit/7920344c75349e70a852417921c645788ddd70a2))
* publish canonical agent documents ([bbf0f6f](https://github.com/rknightion/paperless-ngx-dedupe/commit/bbf0f6f99b06c869ba0e09c6d05a08d93e8ae8f3))
* publish canonical agent documents ([ae02161](https://github.com/rknightion/paperless-ngx-dedupe/commit/ae02161bf1a466794d605b3e00b0eb8b881b5af6))
* publish canonical agent documents ([0a0839d](https://github.com/rknightion/paperless-ngx-dedupe/commit/0a0839d7c45a3e9617a98d0915c0503adfc4ed1a))
* publish canonical agent documents ([d333c04](https://github.com/rknightion/paperless-ngx-dedupe/commit/d333c043fc708bf6314cec6a6a771c0553e4014c))
* publish canonical agent documents ([4754fd6](https://github.com/rknightion/paperless-ngx-dedupe/commit/4754fd6c58f60c86f00bc05132e2c48287086379))
* publish canonical agent documents ([23a538c](https://github.com/rknightion/paperless-ngx-dedupe/commit/23a538cb38e2f4551e6b46aced74163de411f23a))
* publish canonical agent documents ([51f2c61](https://github.com/rknightion/paperless-ngx-dedupe/commit/51f2c612cafd5eb2bcb4abc5e47c9285c875eaa0))
* publish canonical agent documents ([91be436](https://github.com/rknightion/paperless-ngx-dedupe/commit/91be43678e739af6c0389063c6a6eacc198e12d8))
* publish canonical agent documents ([2ddb76b](https://github.com/rknightion/paperless-ngx-dedupe/commit/2ddb76baff7db76593f72fa3b46c1072253f3937))
* publish canonical agent documents ([23ae27b](https://github.com/rknightion/paperless-ngx-dedupe/commit/23ae27b20acdbe6a3b4f6ad6631b22f6a40d4984))
* publish canonical agent documents ([d376934](https://github.com/rknightion/paperless-ngx-dedupe/commit/d3769341a0e8bc51789b2e58a9740a38d2ebf064))
* publish canonical agent documents ([d157e0f](https://github.com/rknightion/paperless-ngx-dedupe/commit/d157e0ff099a9658fbe1013c9bbdf458ca302e98))
* publish public Backlog workspace ([3a34c67](https://github.com/rknightion/paperless-ngx-dedupe/commit/3a34c67f4a263c392c8fbe6093493d5ebea17c02))
...
* sync approved fan-out scheduling and route verification ([f83aa51](https://github.com/rknightion/paperless-ngx-dedupe/commit/f83aa51521780b62b053a0cafed1e5814ffdcc60))
...
* sync authorised Astra root judgement ([e3ba898](https://github.com/rknightion/paperless-ngx-dedupe/commit/e3ba898f457f4855476a27f6408a7c4b1f4cf7b9))
* sync cost-aware fan-out routing and prompt guidance ([a754cb0](https://github.com/rknightion/paperless-ngx-dedupe/commit/a754cb06e73602f42902e4aa0e66198618e0e648))
* sync fan-out async decision-only guidance ([9c65105](https://github.com/rknightion/paperless-ngx-dedupe/commit/9c65105eed844088cd0b0a3bbce1dd57c6cbe1db))
* sync fan-out protocol from agent-docs ad7abd2 ([ccfc807](https://github.com/rknightion/paperless-ngx-dedupe/commit/ccfc807721c424d05a52d1dd212ed80c110d56e0))
* sync fan-out protocol, delegated root authority for unattended runs ([5d5e0d9](https://github.com/rknightion/paperless-ngx-dedupe/commit/5d5e0d920fa6389ebd97139f80ed1c9fe4b7a096))
* sync fan-out protocol, explicit add does not bound the commit ([3ea90da](https://github.com/rknightion/paperless-ngx-dedupe/commit/3ea90da5bbf03ebfca776a1ef836d95b28bdecf2))
* sync fixed Astra low orchestration and rescue routing ([c561cbf](https://github.com/rknightion/paperless-ngx-dedupe/commit/c561cbf4c2fe10bafd35013eb2e75f1d109d5b53))
...
* sync polling and integration contracts ([17d26c1](https://github.com/rknightion/paperless-ngx-dedupe/commit/17d26c164704de59bb7bf24f3986445d04737a4e))
* sync root async question policy ([9e02694](https://github.com/rknightion/paperless-ngx-dedupe/commit/9e02694f9641255e6dddef073c1eb5c391521db6))
* sync same-session fan-out recovery contract ([61eda52](https://github.com/rknightion/paperless-ngx-dedupe/commit/61eda529048a3ee47f9e8e11f341f99c6a2af789))
* sync wave orchestration and existing-root contracts ([60871e0](https://github.com/rknightion/paperless-ngx-dedupe/commit/60871e05688e8e1c00174077ec4d40e737bb1f1b))
* sync wave reliability and worktree contracts ([5e99e17](https://github.com/rknightion/paperless-ngx-dedupe/commit/5e99e171795d202678716afc27f614893ff0c1a3))
...
* mint release-please token from the OpenBao broker ([c5d3f93](https://github.com/rknightion/paperless-ngx-dedupe/commit/c5d3f938ce98e112eda5b00f431bc6aedca1f7c8))
* mint the docs-sync token from the OpenBao broker ([519dce3](https://github.com/rknightion/paperless-ngx-dedupe/commit/519dce36f42ca9e5d2e084f4a12d8fc66c4b0938))


### Bug Fixes

* **deps:** update dependency openai to v7 ([#489](https://github.com/rknightion/paperless-ngx-dedupe/issues/489)) ([a67ff84](https://github.com/rknightion/paperless-ngx-dedupe/commit/a67ff84dc1d55a4c7d775b5796cce1c8958c03db))
* pass the JWT role explicitly for docs-sync ([0794a5a](https://github.com/rknightion/paperless-ngx-dedupe/commit/0794a5acc0742fd501061d42e766676e2648cffc))


### Miscellaneous

* **deps:** lock file maintenance ([#485](https://github.com/rknightion/paperless-ngx-dedupe/issues/485)) ([dfd6576](https://github.com/rknightion/paperless-ngx-dedupe/commit/dfd6576df9c8a43662ac31b53b7778591d723451))
* **deps:** lock file maintenance ([#504](https://github.com/rknightion/paperless-ngx-dedupe/issues/504)) ([3853ed9](https://github.com/rknightion/paperless-ngx-dedupe/commit/3853ed975129ec8c054fb5e6ea5f9b17a7f9af63))
* **deps:** update dependency @playwright/test to v1.62.1 ([#500](https://github.com/rknightion/paperless-ngx-dedupe/issues/500)) ([75c4b9c](https://github.com/rknightion/paperless-ngx-dedupe/commit/75c4b9c935f18a605e34ca940878bc7c7c9c1721))
* **deps:** update dependency @pyroscope/nodejs to v0.6.2 ([#490](https://github.com/rknightion/paperless-ngx-dedupe/issues/490)) ([a9c0f18](https://github.com/rknightion/paperless-ngx-dedupe/commit/a9c0f182b6245fa75dc5ea9c45d2f9e6ef8ac9b4))
* **deps:** update dependency @sveltejs/kit to v2.70.2 ([#495](https://github.com/rknightion/paperless-ngx-dedupe/issues/495)) ([426442a](https://github.com/rknightion/paperless-ngx-dedupe/commit/426442a9f848a9c4f70fd4fd9bafce175322dfbc))
* **deps:** update dependency @types/better-sqlite3 to v9 ([#503](https://github.com/rknightion/paperless-ngx-dedupe/issues/503)) ([5b97503](https://github.com/rknightion/paperless-ngx-dedupe/commit/5b975033984713a5295765b60a2fb5af7ffea5be))
* **deps:** update dependency @typescript-eslint/parser to v8.66.0 ([#515](https://github.com/rknightion/paperless-ngx-dedupe/issues/515)) ([c98f9b7](https://github.com/rknightion/paperless-ngx-dedupe/commit/c98f9b72e0040352eced106e4eec6695e0d71ee6))
* **deps:** update dependency better-sqlite3 to v13.0.2 ([#492](https://github.com/rknightion/paperless-ngx-dedupe/issues/492)) ([68f22f8](https://github.com/rknightion/paperless-ngx-dedupe/commit/68f22f835b896b41739c9fdfa085b688c9bd95bd))
* **deps:** update dependency better-sqlite3 to v13.0.3 ([#520](https://github.com/rknightion/paperless-ngx-dedupe/issues/520)) ([ee7428d](https://github.com/rknightion/paperless-ngx-dedupe/commit/ee7428d426b2a844e410c9f582f49d5d9a50a12d))
* **deps:** update dependency globals to v17.8.0 ([#487](https://github.com/rknightion/paperless-ngx-dedupe/issues/487)) ([58361b6](https://github.com/rknightion/paperless-ngx-dedupe/commit/58361b6790e13a286d7f0ef695d33dd9219464d3))
* **deps:** update dependency globals to v17.9.0 ([#509](https://github.com/rknightion/paperless-ngx-dedupe/issues/509)) ([b004d85](https://github.com/rknightion/paperless-ngx-dedupe/commit/b004d850641633bebc09dff9adb3729b3f13997b))
* **deps:** update dependency nanoid to v6.0.1 ([#513](https://github.com/rknightion/paperless-ngx-dedupe/issues/513)) ([904fd4c](https://github.com/rknightion/paperless-ngx-dedupe/commit/904fd4cda005ce42f405bf44e661c84627904c4f))
* **deps:** update dependency openai to v7.1.0 ([#491](https://github.com/rknightion/paperless-ngx-dedupe/issues/491)) ([37e4449](https://github.com/rknightion/paperless-ngx-dedupe/commit/37e444944fc43fcaa35212192d705c2551d5c184))
* **deps:** update dependency openai to v7.2.0 ([#501](https://github.com/rknightion/paperless-ngx-dedupe/issues/501)) ([deccad2](https://github.com/rknightion/paperless-ngx-dedupe/commit/deccad2b991f7c8c5b30fa4274a0ca22428dc1f1))
* **deps:** update dependency openai to v7.3.0 ([#502](https://github.com/rknightion/paperless-ngx-dedupe/issues/502)) ([00fc3fa](https://github.com/rknightion/paperless-ngx-dedupe/commit/00fc3fab3c040efd4cae72770b2f2c59b1d6bf23))
* **deps:** update dependency openai to v7.4.0 ([#517](https://github.com/rknightion/paperless-ngx-dedupe/issues/517)) ([4ec5298](https://github.com/rknightion/paperless-ngx-dedupe/commit/4ec5298e6daab7b8d9908c8f43b9d46f5a9c6db2))
* **deps:** update dependency svelte-check to v4.7.4 ([#488](https://github.com/rknightion/paperless-ngx-dedupe/issues/488)) ([9ab2d77](https://github.com/rknightion/paperless-ngx-dedupe/commit/9ab2d777821fbf9b5d2140fb7927e347513b99e0))
* **deps:** update dependency svelte-check to v4.7.5 ([#525](https://github.com/rknightion/paperless-ngx-dedupe/issues/525)) ([47e708f](https://github.com/rknightion/paperless-ngx-dedupe/commit/47e708f022b5aaada95b3eb91f4af03861679ebe))
* **deps:** update dependency tsx to v4.23.10 ([#524](https://github.com/rknightion/paperless-ngx-dedupe/issues/524)) ([f83ce22](https://github.com/rknightion/paperless-ngx-dedupe/commit/f83ce223a007f39f1d7cc2744a174cbda93e8e7d))
* **deps:** update dependency tsx to v4.23.11 ([#526](https://github.com/rknightion/paperless-ngx-dedupe/issues/526)) ([5c589eb](https://github.com/rknightion/paperless-ngx-dedupe/commit/5c589eb00e7e338700a1677ac424263671c26391))
* **deps:** update dependency tsx to v4.23.2 ([#505](https://github.com/rknightion/paperless-ngx-dedupe/issues/505)) ([b95a29b](https://github.com/rknightion/paperless-ngx-dedupe/commit/b95a29baa0546bceb020df5f37886c3363303700))
* **deps:** update dependency tsx to v4.23.3 ([#506](https://github.com/rknightion/paperless-ngx-dedupe/issues/506)) ([313a7b9](https://github.com/rknightion/paperless-ngx-dedupe/commit/313a7b90588f7565cd3a9724a5d5d7ac1bcbabb3))
* **deps:** update dependency tsx to v4.23.4 ([#507](https://github.com/rknightion/paperless-ngx-dedupe/issues/507)) ([883705c](https://github.com/rknightion/paperless-ngx-dedupe/commit/883705c30c409fbdb0c96398c1d9904d2f7e86d3))
* **deps:** update dependency tsx to v4.23.5 ([#511](https://github.com/rknightion/paperless-ngx-dedupe/issues/511)) ([dbd6840](https://github.com/rknightion/paperless-ngx-dedupe/commit/dbd68401ec97b1550d700d2196598c18898df622))
* **deps:** update dependency tsx to v4.23.6 ([#519](https://github.com/rknightion/paperless-ngx-dedupe/issues/519)) ([3b0f081](https://github.com/rknightion/paperless-ngx-dedupe/commit/3b0f081c845ede7924605a7163d4d96fa9ec5b34))
* **deps:** update dependency tsx to v4.23.7 ([#521](https://github.com/rknightion/paperless-ngx-dedupe/issues/521)) ([08fd962](https://github.com/rknightion/paperless-ngx-dedupe/commit/08fd9624940e4eb7dc8c53c47bcab9c4534b7e17))
* **deps:** update dependency tsx to v4.23.8 ([#522](https://github.com/rknightion/paperless-ngx-dedupe/issues/522)) ([28a5599](https://github.com/rknightion/paperless-ngx-dedupe/commit/28a5599a80da5cad64c6e0e48996d70d3afe47d8))
* **deps:** update dependency vite to v8.2.0 ([#499](https://github.com/rknightion/paperless-ngx-dedupe/issues/499)) ([84031ec](https://github.com/rknightion/paperless-ngx-dedupe/commit/84031ec17ee1ed0c8e18f6edaba9f5fdff9569a4))
* **deps:** update dependency vite to v8.2.1 ([#523](https://github.com/rknightion/paperless-ngx-dedupe/issues/523)) ([d828958](https://github.com/rknightion/paperless-ngx-dedupe/commit/d8289582b8db597b6ade07472f8013389ddba680))
* **deps:** update faro-web-sdk monorepo to v2.9.0 ([#498](https://github.com/rknightion/paperless-ngx-dedupe/issues/498)) ([cc7914f](https://github.com/rknightion/paperless-ngx-dedupe/commit/cc7914f47d49db0a2f0f7d3a86e38812e1891494))
* **deps:** update github/codeql-action action to v4.37.4 ([#494](https://github.com/rknightion/paperless-ngx-dedupe/issues/494)) ([87996ee](https://github.com/rknightion/paperless-ngx-dedupe/commit/87996eeddd86ce531d638a1dce593a266e881aa0))
* **deps:** update github/codeql-action action to v4.37.5 ([#510](https://github.com/rknightion/paperless-ngx-dedupe/issues/510)) ([b2c4648](https://github.com/rknightion/paperless-ngx-dedupe/commit/b2c46489057019c529174efed9d06440e93c6a3c))
* **deps:** update github/codeql-action action to v4.37.6 ([#518](https://github.com/rknightion/paperless-ngx-dedupe/issues/518)) ([c7581bf](https://github.com/rknightion/paperless-ngx-dedupe/commit/c7581bf9efa65e63501fdea670b2ccf992a3a1ad))
* **deps:** update hadolint/hadolint-action action to v3.4.0 ([#496](https://github.com/rknightion/paperless-ngx-dedupe/issues/496)) ([fed55ff](https://github.com/rknightion/paperless-ngx-dedupe/commit/fed55ffa0966439d1dc532776ca08df3011f8ed2))
* **deps:** update linters & formatters to v8.66.0 ([#516](https://github.com/rknightion/paperless-ngx-dedupe/issues/516)) ([4113328](https://github.com/rknightion/paperless-ngx-dedupe/commit/4113328a842240ea22763fef702c0072b1a9a0c3))
* **deps:** update node.js to v24.18.1 ([#497](https://github.com/rknightion/paperless-ngx-dedupe/issues/497)) ([2dfd848](https://github.com/rknightion/paperless-ngx-dedupe/commit/2dfd8487a0b8122523dc7f54b85986807b46ff8b))
* **deps:** update node.js to v24.19.0 ([#514](https://github.com/rknightion/paperless-ngx-dedupe/issues/514)) ([1b3b0c9](https://github.com/rknightion/paperless-ngx-dedupe/commit/1b3b0c9c83e8b4fc8ad9fb414699990b0db51c31))
* **deps:** update pnpm to v11.18.0 ([#493](https://github.com/rknightion/paperless-ngx-dedupe/issues/493)) ([e3b5337](https://github.com/rknightion/paperless-ngx-dedupe/commit/e3b53371958f3de76ef16d29837712a9fbacd678))
* **deps:** update pnpm/action-setup action to v6.0.10 ([#512](https://github.com/rknightion/paperless-ngx-dedupe/issues/512)) ([6ed0eee](https://github.com/rknightion/paperless-ngx-dedupe/commit/6ed0eeec5155f3e8ebe2b415412ec6072e0cc72b))
...
* **ci:** align Renovate package cooldown ([434d014](https://github.com/rknightion/paperless-ngx-dedupe/commit/434d014ef1f106d7304cce1646bf616d915152e4)), closes [#476](https://github.com/rknightion/paperless-ngx-dedupe/issues/476)
...
* **ci:** give load-sensitive tests realistic timeouts ([5708d50](https://github.com/rknightion/paperless-ngx-dedupe/commit/5708d50296cb70f6741dc358d0843e2f7b9d4e39)), closes [#478](https://github.com/rknightion/paperless-ngx-dedupe/issues/478)
...
* **ci:** make diagnostics version assertions release-safe ([7d61bd2](https://github.com/rknightion/paperless-ngx-dedupe/commit/7d61bd2994943554b495e53f3a3bba9bbbed768e)), closes [#477](https://github.com/rknightion/paperless-ngx-dedupe/issues/477)
...
* **deps:** update dependency @opentelemetry/instrumentation-undici to ^0.31.0 ([#471](https://github.com/rknightion/paperless-ngx-dedupe/issues/471)) ([4e9cf4a](https://github.com/rknightion/paperless-ngx-dedupe/commit/4e9cf4af58e81385e0135a69d62fbecdafdfd9a3))
...
* **deps:** update dependency openai to v6.49.0 ([#472](https://github.com/rknightion/paperless-ngx-dedupe/issues/472)) ([0628aea](https://github.com/rknightion/paperless-ngx-dedupe/commit/0628aeab8a9468d5a6fbabf687858e9fca5381f7))
