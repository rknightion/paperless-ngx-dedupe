...
import { claimDuplicateDeletionPlan, MutationPlanError } from '../../mutation-plans.js';
...
try {
  claimDuplicateDeletionPlan(handle.db, token, jobId, new Date('2026-07-24T11:01:00.000Z'));
