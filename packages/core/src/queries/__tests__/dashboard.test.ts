...
describe('getDashboard', () => {
  ...
  it('returns correct counts with populated data', () => {
    ...
    db.insert(document).values([
      { id: 'doc-1', paperlessId: 1, title: 'Doc A', correspondent: 'Alice', processingStatus: 'completed', archiveFileSize: 1000, syncedAt: '2024-01-01T00:00:00Z' },
      { id: 'doc-2', paperlessId: 2, title: 'Doc B', correspondent: 'Alice', processingStatus: 'completed', archiveFileSize: 2000, syncedAt: '2024-01-01T00:00:00Z' },
      { id: 'doc-3', paperlessId: 3, title: 'Doc C', correspondent: 'Bob', processingStatus: 'pending', archiveFileSize: 3000, syncedAt: '2024-01-01T00:00:00Z' },
    ]).run();
  ...
  it('returns topCorrespondents ranked by group count', () => {
    ...
    db.insert(document).values([
      { id: 'doc-1', paperlessId: 1, title: 'A1', correspondent: 'Alice', syncedAt: '2024-01-01T00:00:00Z' },
      { id: 'doc-2', paperlessId: 2, title: 'A2', correspondent: 'Alice', syncedAt: '2024-01-01T00:00:00Z' },
      { id: 'doc-3', paperlessId: 3, title: 'B1', correspondent: 'Bob', syncedAt: '2024-01-01T00:00:00Z' },
      { id: 'doc-4', paperlessId: 4, title: 'A3', correspondent: 'Alice', syncedAt: '2024-01-01T00:00:00Z' },
    ]).run();

    db.insert(duplicateGroup).values([
      { id: 'grp-1', confidenceScore: 0.9, algorithmVersion: 'v1', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
      { id: 'grp-2', confidenceScore: 0.8, algorithmVersion: 'v1', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
    ]).run();
