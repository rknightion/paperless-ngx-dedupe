...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=30), nullable=True, server_default="pending"
        ),
        sa.Column(
            "target_fields", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("tag_filter", sa.String(length=200), nullable=True),
        sa.Column(
            "include_all", sa.Boolean(), nullable=True, server_default=sa.false()
        ),
        sa.Column("model", sa.String(length=50), nullable=True),
        sa.Column("reasoning_level", sa.String(length=20), nullable=True),
        sa.Column("max_input_chars", sa.Integer(), nullable=True),
        sa.Column(
            "prompt_version", sa.String(length=20), nullable=True, server_default="v1"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "suggested_tags", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.Column(
            "raw_response", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "requested_fields", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("error", sa.Text(), nullable=True),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        "ix_ai_extraction_results_job_id",
        "ai_extraction_results",
        ["job_id"],
        unique=False,
    )
...
def downgrade():
    op.drop_index(
        "ix_ai_extraction_results_document_id", table_name="ai_extraction_results"
    )
    op.drop_index("ix_ai_extraction_results_job_id", table_name="ai_extraction_results")
    op.drop_index(
        op.f("ix_ai_extraction_results_id"), table_name="ai_extraction_results"
    )
