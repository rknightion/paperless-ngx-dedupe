...
down_revision: Union[str, Sequence[str], None] = '84daede32136'
...
def upgrade() -> None:
    ...
    op.create_index('ix_documents_unprocessed', 'documents',
                   ['paperless_id'], unique=False,
                   postgresql_where=text("processing_status = 'pending'"))

    op.create_index('ix_duplicate_groups_unreviewed', 'duplicate_groups',
                   ['confidence_score'], unique=False,
